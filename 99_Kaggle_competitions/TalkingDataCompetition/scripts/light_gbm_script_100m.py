...
train_df = pd.read_csv(path+"train.csv", nrows=1000000000, dtype=dtypes, usecols=['ip','app','device','os', 'channel', 'click_time', 'is_attributed'])
...
print("writing...")
sub.to_csv('../output/sub_lgb_balanced997.csv',index=False)
print("done...")