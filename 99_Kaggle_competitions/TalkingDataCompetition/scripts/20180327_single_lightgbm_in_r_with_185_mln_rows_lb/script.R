...
#*****************************************************************
#Process chunk size of 185 million rows from training data

total_rows <- 184903890
chunk_rows <- 184903890
skip1_rows <- total_rows - chunk_rows 

tic("Total processing time for train data --->")
train <- train_chunker("Chunk of 185 million rows", skip1_rows, chunk_rows)
dim(train)
...
fwrite(sub, "../../output/sub_lightgbm_R_185m.csv")
head(sub,10)
